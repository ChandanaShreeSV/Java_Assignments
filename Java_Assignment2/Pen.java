public final class Pen {
        ...
        private static int penCounter = 0; // static variable for total pens created
        private final int penID;           // unique ID for each pen
        ...
        public Pen(int inkLevel, String inkColor, String tipType) {
            ...
            this.isCapped = true;
            penCounter++;
            this.penID = penCounter; // assign unique ID
